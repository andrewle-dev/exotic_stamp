...
public final class MailSubjectConstants {
    ...
    public static final String VERIFY_ACCOUNT = "Verify your Exotic Stamp account";
    public static final String OTP_VERIFICATION_CODE = "Your Exotic Stamp verification code";
