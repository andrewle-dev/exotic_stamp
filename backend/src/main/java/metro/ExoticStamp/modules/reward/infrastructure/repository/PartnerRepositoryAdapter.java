...
public class PartnerRepositoryAdapter implements PartnerRepository {
    ...
    @Override
    public List<Partner> findActiveWithBannerOrderedByUpdatedAtDesc() {
        return jpaPartnerRepository.findByActiveTrueAndBannerImageUrlIsNotNullOrderByUpdatedAtDesc();
    }
